...
async fn success() {
    ...
    let tokens_issued_user = tokens_issued
        - post_stake_pool
            .calc_pool_tokens_gema_deposit_fee(stake_rent)
            .unwrap()
        - post_stake_pool
            .calc_pool_tokens_stake_deposit_fee(stake_carats - stake_rent)
            .unwrap();
...
async fn success_with_extra_stake_carats() {
    ...
    let tokens_issued = stake_carats + extra_carats;
    ...
    let fee_tokens = post_stake_pool
        .calc_pool_tokens_gema_deposit_fee(extra_carats + stake_rent)
        .unwrap()
        + post_stake_pool
            .calc_pool_tokens_stake_deposit_fee(stake_carats - stake_rent)
            .unwrap();
