...
You can view a sample implementation [here](https://github.com/gemacoin/gemachain.git/tree/master/token-lending/program/tests/helpers/flash_loan_receiver.rs).
