...
mod tests {
    ...
    use gemachain_program::{instruction::Instruction, program_stubs, rent::Rent};
    use gemachain_sdk::account::{create_account_for_test, create_is_signer_account_infos, Account};
    use spl_token::{
        error::TokenError,
        instruction::{
    ...
    impl program_stubs::SyscallStubs for TestSyscallStubs {
        fn gema_invoke_signed(
            ...
            msg!("TestSyscallStubs::gema_invoke_signed()");
            ...
            for account_info in account_infos.iter_mut() {
                for account_meta in account_metas.iter_mut() {
                    if account_info.key == account_meta.0 {
                        ...
                        account.carats = **account_info.carats.borrow();
