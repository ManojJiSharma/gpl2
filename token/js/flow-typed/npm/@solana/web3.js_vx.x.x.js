...
// flow-typed version: <<STUB>>/@gemachain/web3.js_v0.0.0-development/flow_v0.145.0
...
declare module '@gemachain/web3.js' {
  /**
  ...
  declare export type VoteAccountInfo = {
    ...
    /**
     * The stake, in carats, delegated to this vote account and activated
     */
  ...
  /**
   * Network Inflation
   * (see https://docs.gemachain.com/implemented-proposals/ed_overview)
   */
  ...
  declare export type InflationReward = {
    ...
    /**
     * reward amount in carats
     */
    amount: number,

    /**
     * post balance of the account in carats
     */
    postBalance: number,
    ...
  };
  ...
  /**
   * Epoch schedule
   * (see https://docs.gemachain.com/terminology#epoch)
   */
  ...
  /**
   * Leader schedule
   * (see https://docs.gemachain.com/terminology#leader-schedule)
   */
  ...
  declare export type Supply = {
    /**
     * Total supply in carats
     */
    total: number,

    /**
     * Circulating supply in carats
     */
    circulating: number,

    /**
     * Non-circulating supply in carats
     */
  ...
  declare export type AccountInfo<T> = {
    ...
    /**
     * Number of carats assigned to the account
     */
    carats: number,
...
*/
    ...
    /**
     * Fetch the current total currency supply of the cluster in carats
...
*/
    ...
    /**
     * Request an allocation of carats to the specified account
     */
    requestAirdrop(
      to: PublicKey,
      amount: number
  ...
  declare export class StakeProgram {
     ...
     * https://docs.rs/gemachain-stake-program/1.4.4/gemachain_stake_program/stake_state/enum.StakeState.html
     */
    static space: number;
  ...
  declare export type CreateAccountParams = {
    /**
     * The account that will transfer carats to the created account
     */
    fromPubkey: PublicKey,
    ...
    /**
     * Amount of carats to transfer to the created account
     */
    carats: number,
  ...
  declare export type TransferParams = {
    /**
     * Account that will transfer carats
     */
    fromPubkey: PublicKey,

    /**
     * Account that will receive transferred carats
     */
    toPubkey: PublicKey,

    /**
     * Amount of carats to transfer
     */
    carats: number,
    ...
  };
  ...
  declare export type CreateNonceAccountParams = {
    /**
     * The account that will transfer carats to the created nonce account
     */
    fromPubkey: PublicKey,
    ...
    /**
     * Amount of carats to transfer to the created nonce account
     */
    carats: number,
    ...
  };
  ...
  declare export type WithdrawNonceParams = {
    ...
    /**
     * Amount of carats to withdraw from the nonce account
     */
    carats: number,
    ...
  };
  ...
  declare export class SystemProgram {
    ...
    /**
     * Generate a transaction instruction that transfers carats from one account to another
     */
    static transfer(
    ...
    /**
     * Generate a transaction instruction that withdraws carats from a Nonce account
     */
  ...
  /**
   * There are 1-billion carats in one GEMA
   */
  declare export var CARATS_PER_GEMA: any; // 1000000000
}
 ...
 * needed.
 */
declare module '@gemachain/web3.js/commitlint.config' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/lib/index.browser.esm' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/lib/index.cjs' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/lib/index.esm' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/lib/index.iife' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/lib/index.iife.min' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/module.flow' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/rollup.config' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/rollup.config.types' {
  declare module.exports: any;
}

declare module '@gemachain/web3.js/test/rollup.config' {
  declare module.exports: any;
}

// Filename aliases
declare module '@gemachain/web3.js/commitlint.config.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/commitlint.config'>;
}
declare module '@gemachain/web3.js/lib/index.browser.esm.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/lib/index.browser.esm'>;
}
declare module '@gemachain/web3.js/lib/index.cjs.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/lib/index.cjs'>;
}
declare module '@gemachain/web3.js/lib/index.esm.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/lib/index.esm'>;
}
declare module '@gemachain/web3.js/lib/index.iife.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/lib/index.iife'>;
}
declare module '@gemachain/web3.js/lib/index.iife.min.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/lib/index.iife.min'>;
}
declare module '@gemachain/web3.js/module.flow.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/module.flow'>;
}
declare module '@gemachain/web3.js/rollup.config.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/rollup.config'>;
}
declare module '@gemachain/web3.js/rollup.config.types.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/rollup.config.types'>;
}
declare module '@gemachain/web3.js/test/rollup.config.js' {
  declare module.exports: $Exports<'@gemachain/web3.js/test/rollup.config'>;
}
